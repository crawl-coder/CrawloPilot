...
> ⚠️ **重要**: 开发前必须先阅读 [系统目标与核心定位](./system-goals.md),了解项目的零侵入设计原则!

## 📚 可用 Skills

### 0. [系统目标与核心定位](./system-goals.md) ⭐ 必读
**适用场景**: 了解 CrawloPilot 的核心目标和设计原则

**包含内容**:
- 🎯 系统目标: Crawlo 爬虫的零侵入式管理平台
- 🏗️ 核心架构原则: 零侵入设计、SDK 定位、数据采集方式
- 📦 核心组件: Spider Runner / TaskExecutor / LogCollector
- 🚫 禁止的设计: 强制 SDK 集成、修改爬虫代码
- ✅ 正确的设计: 零侵入部署、日志采集、可选 SDK
- 📋 开发检查清单: 确保不偏离初衷

**必读原因**: 本文档定义了 CrawloPilot 的核心定位,所有开发必须遵循零侵入原则!
